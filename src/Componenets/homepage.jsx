            ...
            <div className="relative p-4">
                <div className="-ml-5 lg:mt-4 ">
                    <div className="grid relative bg-no-repeat mr-2 lg:w-[465px] " style={{ backgroundImage: "url('./pics/paragraphebg.png')" }}>
                         <div className="col-span-5 m-4 mb-2  border-solid w-[44.49px] h-[44.49px] lg:w-[62px] lg:h-[62px]" ><img src="./pics/mecaniclogo.png" alt="" /> </div>
                ...
                <div className="-ml-5 mt-2 lg:mt-3">
                    <div className="grid relative bg-no-repeat mr-2 lg:w-[465px]" style={{ backgroundImage: "url('./pics/paragraphebg.png')" }}>
                         <div className="grid-cols-3 m-4 mb-2 border-solid w-[44.49px] h-[44.49px] lg:w-[62px] lg:h-[62px]" ><img src="./pics/secplogo.png" alt="" /> </div>
                          <div className="ml-24 -mt-[58px] grid-cols-6">
                               <p className="font-turretBold text-[15px] text-[#3C2B1F] font-[800] uppercase lg:txet-[19.96px]">LOREM IPSUM DOLOR</p>
                              <p className="font-turret text-[12px] mb-4 text-[#323131] lg:txet-[14.41px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec dolor ante, posuere.</p>
                         </div>
    ...
    <div className="relative min-h-screen lg:hidden " >
        ...
        <div className="relative z-10 -mt-32 ml-[27.3px]">
           <div>
            ...
            <div
  className="relative z-0 bg-no-repeat bg-cover py-8 px-6 w-full h-[480px] -ml-4 "
    ...
    <div className="hidden lg:block relative h-screen lg:mt-10 lg:-ml-10 lg:w-screen lg:mr-4  lg:mt-52" >
        ...
        <div className="relative z-10 -mt-32 ml-[27.3px] lg:ml-48 lg:-mt-[28rem]">
           <div>
            ...
            <div
  className="relative z-0 bg-no-repeat bg-cover py-8 px-6 w-[430.41px] h-screen -ml-4 lg:-mt-[29rem] lg:ml-[31rem] lg:w-[461.41px] lg:h-[512.49px] "
  style={{ backgroundImage: "url('./pics/formbgd.png')" }}
>
